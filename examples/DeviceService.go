...
import (
	...
	goonvif "github.com/tarokker/onvif"
	"github.com/tarokker/onvif/device"
	"github.com/tarokker/onvif/gosoap"
	"github.com/tarokker/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		/*
			You could use https://github.com/tarokker/onvif/gosoap for pretty printing response
		*/
